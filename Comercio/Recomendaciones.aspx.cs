...
public partial class Recomendaciones : System.Web.UI.Page
{
    ...
    private void cargarGridView()
    {
        ...
        List<Categoria> listaCategoriaOrdenada = auxAContar
                .OrderBy(o => o.NombreCat)
                .ToList();
        List<Producto> listaProducto1 = new List<Producto>();
        foreach (Categoria unaCat in listaCategoriaOrdenada)
        { 
        
        }

        this.gvProductos.DataSource = listaCategoriaOrdenada;
