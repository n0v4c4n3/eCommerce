...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="Yellow" BorderStyle="Double" HorizontalAlign="Center">
        <Columns>
            ...
            <asp:CheckBoxField DataField="Ban" Text="Ban" />
            <asp:BoundField DataField="DireccionFacturacion" HeaderText="Dir. Fact." />
            <asp:TemplateField HeaderText="Dir. Envio">
                <ItemTemplate>
                    <asp:ListBox ID="BulletedList1" runat="server" DataSource='<%# Eval("DireccionEnvio") %>'></asp:ListBox>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
